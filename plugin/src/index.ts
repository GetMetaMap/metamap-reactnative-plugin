...
const pkg = require('react-native-mati-global-id-sdk/package.json');
...
const gradleMaven =
  'allprojects { repositories { maven { url "$rootDir/../node_modules/react-native-mati-global-id-sdk/android/maven" } } }';
...
export function setGradleMaven(buildGradle: string): string {
  if (buildGradle.includes('react-native-mati-global-id-sdk/android/maven')) {
    return buildGradle;
  }
